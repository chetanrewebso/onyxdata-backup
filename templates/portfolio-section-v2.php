...
/**
 * Template Name: PORTFOLIO PAGE V2 
 */
get_header();
...
<div class="filters" >
            ...
            <div class="serch portfolio">
                <label></label>
                <input type="text" id="search-portfolio" placeholder="Search portfolio"> 
            </div>
...
<section>
     ...
     <div class="container">
        <div class="row">
            <div class="col-lg-12 mx-auto text-center heading-section">
                <h2 class="mb-3 heading"> <?php the_field('challenge_heading'); ?></h2>
                <p class="mb-4 subheading"> <?php the_field('challenge_subheading'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="filter-container container">
        <div class="filter-box">
            ...
            <input type="text" id="dataset" placeholder="Search Challenges">
        </div>
        ...
        <div class="filter-box">
            ...
            <select id="year">
                ...
                <?php
                global $wpdb;
                $years = $wpdb->get_col("SELECT DISTINCT YEAR(post_date) FROM $wpdb->posts WHERE post_status = 'publish' AND post_type = 'challenges' ORDER BY post_date DESC");
        ...
        <div class="filter-box">
            ...
            <select id="month">
                ...
                for ($m = 1; $m <= 12; $m++) {
                    ...
                    echo '<option value="' . esc_attr($m) . '">' . esc_html($monthName) . '</option>';
                }
                ?>
            </select>
        </div>
...
<!-- <section> -->
    <div class="container" style="position:relative;">
        <div class="portfolio-grid mt-5" id="challenge-results">
            <?php
            ...
            if ($challenge_query->have_posts()) :
                while ($challenge_query->have_posts()) : $challenge_query->the_post();
                    ...
                    $content    = get_the_excerpt(); // Get excerpt or content
                    $author     = get_the_author(); // Get post author
                    $permalink  = get_permalink(); // Get post link
                    
                    // Get tags or skills from custom field (Adjust field name accordingly)
                    $tags = get_post_meta(get_the_ID(), 'skills_and_tools', true);
                    $tag_list = maybe_unserialize($tags); // Unserialize if stored as serialized array
            ?>
                <div class="portfolio-card">
                    <img src="<?php echo esc_url($image_url ?: 'assets/images/default.webp'); ?>" alt="<?php echo esc_attr($title); ?>" class="card-image">
                    <div class="card-content">
                        <h2 class="card-title"><?php echo esc_html($title); ?></h2>
                        <p class="card-description"><?php echo esc_html($content); ?></p>
                        <p class="card-author">By <?php echo esc_html($author); ?></p>
                        <div class="tags">
                            <?php 
                        ...
                        <a href="<?php echo esc_url($permalink); ?>" class="view-button">View Details</a>
                    </div>
                </div>
            <?php
                endwhile;
        ...
        <div id="portfolio-loading-overlay-2" style="display: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgb(14 12 12 / 42%);; z-index: 9; justify-content: center; align-items: center;">
    <div id="portfolio-loader-2" style="text-align: center;">
        <img src="https://datadna.onyxdata.co.uk/wp-content/themes/onyxdata-child/custom-function/images/Loading-icon-unscreen.gif" alt="Loading..." width="50">
        <p style="color: #333; margin-top: 15px;"></p>
      </div>
     </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="portfolioModalLabel">Create Portfolio</h5>
                ...
                <div class="modal-body">
                    <form id="portfolioForm">
                        ...
                        <div class="mb-3">
                            <label for="portfolioImage" class="form-label">Upload Image</label>
                            <input type="file" class="form-control" id="portfolioImage">
                        </div>
                        <div class="mb-3">
                            <div>
                                <img src="assets/images/pic.jpg" alt="image" class="portfolio-img">
                            </div>

                        </div>
                        <div class="mb-3">
                            <label for="portfolioLink" class="form-label">Project Link</label>
                            <input type="url" class="form-control" id="portfolioLink" placeholder="Enter Project Link">
                        </div>
